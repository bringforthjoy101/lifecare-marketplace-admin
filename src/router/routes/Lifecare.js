...
const ManagerRoutes = [
	...
	{
		path: "/clients/list",
		component: lazy(() => import("../../views/lifecare/clients/list")),
	},
	{
		path: "/client/view",
		exact: true,
		component: () => <Redirect to="/lifecare/clients/view/1" />,
	},
	{
		path: "/client/view/:id",
		component: lazy(() => import("../../views/lifecare/clients/view")),
		meta: {
			navLink: "/lifecare/clients/view",
		},
	},
	{
		path: "/products/list",

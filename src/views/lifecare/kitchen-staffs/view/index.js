...
// ** Store & Actions
import { getUser, getUserAllTransactions, getClientDetails, trackUser } from '../store/action'
...
const UserView = props => {
  ...
  return store.clientDetails !== null && store.clientDetails !== undefined ? (
    <div className='app-user-view'>
      <Row>
        <Col xl='9' lg='8' md='7'>
          <UserInfoCard clientDetails={store.clientDetails} userRole={userData?.role} />
        </Col>
        {userData?.role === 'manager' || userData?.role === "busary" ? <Col xl='3' lg='4' md='5'>
          {/* <PlanCard  clientDetails={store.clientDetails} /> */}
        </Col> : ""}
      </Row>

...
const CategoryTable = () => {
	...
	const [currenttype, setCurrenttype] = useState({ value: '', label: 'Select type' })
	...
	const filteredData = store.allData.filter((item) => item.name.toLowerCase() || item.slug.toLowerCase() || item.type.name.toLowerCase() || item.id)
						...
						<Col lg="4" md="6">
							<FormGroup>
								...
								<Input
									...
									type="text"
									value={searchTerm}
									placeholder="Search Id, Network and Category"

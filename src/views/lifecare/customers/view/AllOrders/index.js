		...
		<div className="invoice-list-table-header w-100 py-2">
			<Row>
				<Col lg="6" sm="12" className="d-flex align-items-center px-0 px-lg-1 mb-2">
					...
					<h3 className="d-none d-lg-block">{customerDetails?.names?.split(' ')[0]}'s Orders</h3>
				</Col>
				<Col
					lg="3"
					sm="6"
...
const TransactionList = () => {
	...
	const filteredData = store?.customerDetails.orders?.filter((item) => item?.trackingNumber?.toLowerCase() || item?.orderStatus?.name.toLowerCase())

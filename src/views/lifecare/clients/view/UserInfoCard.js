...
const UserInfoCard = ({ clientDetails, userRole }) => {
  ...
  const getTotalSpent = (transactions) => {
    const paidOrders = transactions.filter(item => { return item.status === 'paid' })
    const totalPrice = paidOrders.reduce(function (accumulator, item) {
          ...
          <Col xl='6' lg='12' className='d-flex flex-column justify-content-between border-container-lg'>
              ...
              {renderClientImg()}
                <div className='d-flex flex-column ml-1'>
                  <div className='user-info mb-1'>
                    <h4 className='mb-0'>{clientDetails !== null ? `${clientDetails.names}` : 'Client Name'}</h4>
                    <CardText tag='span'>
                     {clientDetails?.phone}, {clientDetails?.location}
                    </CardText>
                  </div>
            ...
            <div className='d-flex align-items-center user-total-numbers'>
              ...
              <div className='d-flex align-items-center'>
                ...
                <div className='ml-1'>
                  <h5 className='mb-0'>{getTotalSpent(clientDetails.orders).toLocaleString('en-US', { style: 'currency', currency: 'NGN' })}</h5>
          ...
          <Col xl='6' lg='12' className='mt-2 mt-xl-0'>
            <div className='user-info-wrapper'>
                <div className='d-flex flex-wrap align-items-center mt-0'>
                  ...
                  <CardText className='mb-0'> {clientDetails?.phone}</CardText>
                </div>
                <div className='d-flex flex-wrap align-items-center mt-1'>
                  ...
                  <CardText className='text-capitalize mb-0'>{clientDetails?.location}</CardText>
                </div>
                <div className='d-flex flex-wrap align-items-center mt-1'>
                  <div className='user-info-title'>
